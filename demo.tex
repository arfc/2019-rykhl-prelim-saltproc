...
\begin{figure}[htp!] % replace 't' with 'b' to 
	...
	\caption{\gls{TAP} reprocessing scheme flowchart used for SaltProc v1.0 
...
demonstrate 
the effective 
multiplication factors  obtained using SaltProc v1.0 and Serpent. I obtained 
...
dynamic \gls{SVF} functionality to SaltProc v1.0.
...
I checked correctness of SaltProc v1.0 by comparing mass of important 
...
\begin{align}
\qquad\qquad & m_{post} = m_{pre} \times  
...
the nickel filter is only 5\%. Figure~\ref{fig:xe-i} shows that SaltProc v1.0 
...
reprocessing system simulated with SaltProc v1.0 allows keeping $^{135}$Xe 
