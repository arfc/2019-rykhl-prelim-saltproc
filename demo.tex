...
simulation will be be performed with moderate time resolution (e.g., 30-day 
...
\gls{TAP} in load following regime would capture effects of xenon poisoning 
and evaluate benefit of using online gas removal system.
