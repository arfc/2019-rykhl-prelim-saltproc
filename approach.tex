...
\begin{figure}[htp!] % replace 't' with 'b' to 
	...
	the gas removal system, the $\epsilon_m$ is the migration efficiency of 
...
with online fuel reprocessing system. SaltProc v0.1 uses HDF5 
\cite{the_hdf_group_hierarchical_1997} to store 
data and uses the PyNE Nuclear Engineering Toolkit \cite{scopatz_pyne_2012}
for Serpent 2 output file parsing and nuclide naming. SaltProc v0.1 is an 
