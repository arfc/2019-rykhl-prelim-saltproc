...
An outline of this work is shown in Figure~\ref{fig:workflow}.
 \begin{sidewaysfigure}[ht!] % replace 't' with 'b' to force it to 
 	\centering
 	\includegraphics[width=1.05\textwidth]{progress_chart.pdf} 
...
results will be verified with ChemTriton results for unit cell and full-core 
geometry from recent \gls{ORNL} research 
\cite{betzler_two-dimensional_2017, betzler_assessment_2017}.
